...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">PT</a> </h1> <!-- Uncomment below if
    you prefer to use an image logo -->
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="#produk">Product</a></li>
                    @if(!Auth::check())
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Print Your Memories With Our Printer</h1>
        ...
        <section id="produk" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Printer</h2>
                    <p>brands available in our shop</p>
                </div>
                        ...
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    ...
                                    |
                                    @if(Auth::check())
                                    <a href="" data-bs-toggle="modal" data-bs-target="#ModalTambahpembelian{{$p->kode}}" title="Pesan"><i class="bx bx-link"></i>BUY</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-body clearfix">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Type : {{$p->tipe}}</p>
                                            <p class="card-text">Jenis : {{$p->jenis}}</p>
                                            <p class="card-text">Price : Rp.{{$p->harga}}</p>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>Fyrdan</strong>. All Rights Reserved
                    </div>
                    <div class="credits">
                        Designed by <a href="https://rpl-tamsis2jakarta.webnode.page/">Fauzy</a>
                    </div>
                </div>
                <div class="col-lg-6">
